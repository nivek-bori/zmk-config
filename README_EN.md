...
3. Make sure the `corne` project in [`config/west.yml`](config/west.yml) still works. The `boards/arm/corne` folder will be downloaded from this URL.
4. If there is still a `boards/arm/corne` folder in your fork, delete it.
